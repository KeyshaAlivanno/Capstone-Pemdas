...
public class SnL{
    ...
    public SnL(int s){
        ...
        this.turnTimer = new TurnTimer(soundPlayer);
    }
    ...
    public void play(){
        ...
        do {
            ...
            while (!turnTimer.isTimeUp()) {
                if (read.hasNextLine()) {
                    ...
                    if (enter.isEmpty()) {
                        ...
                        soundPlayer.playSound("dice.wav");  // Tambahkan ini
                        break;
                    }
                }
            }
            ...
            if (turnTimer.isTimeUp()) {
                System.out.println("Time is up! Skipping turn...");
            } else {
        ...
        soundPlayer.playSound("win.wav");  // Tambahkan ini
